function allVariables = configureVariables()
    ...
    allVariables.addIMUVis = false; %% This doesn't work yet. 

    %% Set video section to analyse
    allVariables.startFrame = 12800; %% Change these values to the frames you would like to process. 
    allVariables.endFrame = 12900;
    ...
    allVariables.GeneralPath = "FullDataSet/raw-data-export/2023-07-25/";
    ...
    allVariables.ret_res = 800; % pixel resolution of retinal image space (square) [I still don't fully understand this one or the next two parameters (NP)]
    allVariables.calibDist = 600; % Should this be the focal length in pixels? [Solved Yes]
    ...
    allVariables.flowVisType = 'Color'; % 'Color' doesn't work right now. Need to fix it. 
    allVariables.flowIntervalDownSample = 40;
